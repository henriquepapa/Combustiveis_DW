...
def carga_glp():
    ...
    path = 'Base_CSV/Etanol e gasolina'
    os.chdir(path)
    ...
    tqdm.write('Inserindo na Etanol')

    table_create_id = table_id + ".combustivel_etanol"

    job = client.load_table_from_dataframe(
        etanol, table_create_id
    )
    job.result()

    tqdm.write('Inserindo na gasolina')

    table_create_id = table_id + ".combustivel_gasolina"

    job = client.load_table_from_dataframe(
        gasolina, table_create_id
    )
    job.result()